...
import { FaArrowUp, FaBeer } from "react-icons/fa";
        ...
        <div>
            ...
            <div className='bg-black'>
                <div className='2xl:mx-40 2xl:py-52 lg:py-32 lg:mx-24 border-b border-[#FFFFFF99]'>
                    <h3 className='Alliance 2xl:text-[90px] lg:text-6xl text-white uppercase'>Downwinder is the community app around downwind that accompanies all downwind enthusiasts before and after their outings.</h3>
                </div>
                ...
                <div className='2xl:mt-20 2xl:pb-56 lg:pb-40 lg:mt-14 2xl:mx-40 lg:mx-24 grid 2xl:grid-cols-4 lg:grid-cols-3 gap-5'>
                    <div className='text-white border-2 border-[#1D98FF99] p-7 rounded-[10px]'>
                        <div>
                    ...
                    <div className='text-white border-2 p-7 border-[#1D98FF99] rounded-[10px]'>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
                    ...
                    <div className='text-white border-0 p-7 bg-[#1D98FF] rounded-[10px]'>
                        <div>
