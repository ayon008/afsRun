...
const Discover = () => {
    ...
    return (
        <div className='bg-black Alliance'>
            {/* Discover Text */}
            <div>
                <h2 className='2xl:pt-44 lg:pt-36 pt-28 text-center font-bold tracking-wider text-white w-fit mx-auto 2xl:text-7xl lg:text-5xl text-3xl'>Discover 300,000 routes <br /> and POIs around the world.</h2>
            </div>
            {/* Filter Section */}
            <div>
                <div className='flex lg:flex-row flex-col items-center gap-5 mt-10 2xl:ms-40 lg:ms-28'>
